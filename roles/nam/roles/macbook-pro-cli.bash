...
function main()
{
    ...
    sudo -u "${SUDO_USER}" "${appFolderPath}/../../../cookbooks/awscli/recipes/install.bash"
    ...
    sudo -u "${SUDO_USER}" "${appFolderPath}/../../../cookbooks/go/recipes/install.bash"
    ...
    sudo -u "${SUDO_USER}" "${appFolderPath}/../../../cookbooks/jq/recipes/install.bash"
    ...
    sudo -u "${SUDO_USER}" "${appFolderPath}/../../../cookbooks/node/recipes/install.bash"
    sudo -u "${SUDO_USER}" "${appFolderPath}/../../../cookbooks/packer/recipes/install.bash"
    sudo -u "${SUDO_USER}" "${appFolderPath}/../../../cookbooks/shellcheck/recipes/install.bash"
    sudo -u "${SUDO_USER}" "${appFolderPath}/../../../cookbooks/terraform/recipes/install.bash"
    sudo -u "${SUDO_USER}" "${appFolderPath}/../../../cookbooks/testssl/recipes/install.bash"
